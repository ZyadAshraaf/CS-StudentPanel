...
<section id="Hcarousel" class="d-flex justify-content-center align-items-center">
...
</section><!-- End Header Carousel Section -->
...
<main id="main">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content"
                    ...
                    <p class="fst-italic">
                        ...
                        Imagine being able to track the development of an individual student across the entire student
                        life-cycle
                    ...
                    <p>
                        ...
                        programmes, so
                        you’ll be able to respond to the needs of students today – and tomorrow – faster and with a more
                        connected
                        infrastructure.
                    </p>
    ...
    <section id="counts" class="counts section-bg">
        <div class="container">
            ...
            <div class="row counters">
                ...
                <div class="col-lg-3 col-6 text-center">
                    <img src="./assets/img/trainerUniversity-removebg-preview.png" alt="error404"
                ...
                <div class="col-lg-4 d-flex align-items-stretch">
                    <div class="content">
                        ...
                        <p>
                            ...
                            established on
                            July 26, 1975 by Act No. 70 of 1975 over 350 acres of land. It is the youngest of 3 major
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 d-flex align-items-stretch">
                                <div class="icon-box mt-4 mt-xl-0">
                                    ...
                                    <h4>Sectors</h4>
                                    <p>
                                        <a href=" http://www.helwan.edu.eg/?p=35458&lang=en">Postgradyate Studies and
                                            Research Sector </a>
                                        <a href="http://www.helwan.edu.eg/?p=35458&lang=en">Education an Student Affairs
                                            Sector </a>
    ...
    <section class="ContactUSection">
        <h2 class="text-center">Contact Us <img class="ContactUsImage"
                src="./assets/img/2587327-200-removebg-preview.png"></h4>
            <div class="container">
                <div class="form">
                    <div class="contact-info">
                        <h3 class="title">Let's get in touch</h3>
                        <p class="text"> Contact us with the following details. and fillup the form with the details.
                        </p>
                        <div class="info">
                            ...
                            <div class="social-information"> <i class="fa fa-envelope-o"></i>
                                <p>contact@HelwanUniversity.com</p>
                            </div>
                        ...
                        <div class="social-media">
                            <p>Connect with us :</p>
                            <div class="social-icons"> <a href="#"> <i class="bx bxl-facebook"></i> </a> <a href="#"> <i
                                        class="bx bxl-twitter"></i> </a> <a href="#"> <i class="bx bxl-instagram"></i>
                                </a> <a href="#">
                                    <i class="bx bxl-linkedin"></i> </a> </div>
                        </div>
                    </div>
                    <div class="contact-info-form"> <span class="circle one"></span> <span class="circle two"></span>
                        <form action="#" onclick="return false;" autocomplete="off">
                            ...
                            <div class="social-input-containers"> <input type="tel" name="phone" class="input"
                                    placeholder="Phone" />
                            </div>
                            <div class="social-input-containers textarea"> <textarea name="message" class="input"
                                    placeholder="Message"></textarea> </div> <input type="submit" value="Send"
                                class="btn" />
                        </form>
                    </div>
                </div>
